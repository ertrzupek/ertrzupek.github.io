...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmMemory = wasmExports["Df"];
    updateMemoryViews();
    wasmTable = wasmExports["Ff"];
    addOnInit(wasmExports["Ef"]);
...
var ASM_CONSTS = {
  ...
  78786: () => window.innerWidth,
  78816: () => window.innerHeight,
};
...
var wasmImports = {
  ...
  Ac: _eglCreateWindowSurface,
  pc: _eglDestroyContext,
  Lc: _eglDestroySurface,
  Ye: _eglGetConfigAttrib,
  K: _eglGetDisplay,
  Vb: _eglGetError,
  re: _eglInitialize,
  Wc: _eglMakeCurrent,
  ...
  J: _emscripten_asm_const_ptr_sync_on_main_thread,
  M: _emscripten_cancel_main_loop,
  Qa: _emscripten_date_now,
  Aa: _emscripten_exit_fullscreen,
  eb: _emscripten_exit_pointerlock,
  Cd: _emscripten_force_exit,
  ...
  Bc: _emscripten_glBlitFramebuffer,
  ...
  R: _emscripten_glClearColor,
  Q: _emscripten_glClearDepthf,
  P: _emscripten_glClearStencil,
  Cb: _emscripten_glClientWaitSync,
  cd: _emscripten_glClipControlEXT,
  O: _emscripten_glColorMask,
  N: _emscripten_glCompileShader,
  Bf: _emscripten_glCompressedTexImage2D,
  Sc: _emscripten_glCompressedTexImage3D,
  Af: _emscripten_glCompressedTexSubImage2D,
  Rc: _emscripten_glCompressedTexSubImage3D,
  Pb: _emscripten_glCopyBufferSubData,
  zf: _emscripten_glCopyTexImage2D,
  yf: _emscripten_glCopyTexSubImage2D,
  Tc: _emscripten_glCopyTexSubImage3D,
  xf: _emscripten_glCreateProgram,
  wf: _emscripten_glCreateShader,
  vf: _emscripten_glCullFace,
  uf: _emscripten_glDeleteBuffers,
  tf: _emscripten_glDeleteFramebuffers,
  sf: _emscripten_glDeleteProgram,
  Pc: _emscripten_glDeleteQueries,
  ya: _emscripten_glDeleteQueriesEXT,
  rf: _emscripten_glDeleteRenderbuffers,
  ub: _emscripten_glDeleteSamplers,
  qf: _emscripten_glDeleteShader,
  Db: _emscripten_glDeleteSync,
  pf: _emscripten_glDeleteTextures,
  jb: _emscripten_glDeleteTransformFeedbacks,
  wc: _emscripten_glDeleteVertexArrays,
  ma: _emscripten_glDeleteVertexArraysOES,
  of: _emscripten_glDepthFunc,
  nf: _emscripten_glDepthMask,
  mf: _emscripten_glDepthRangef,
  lf: _emscripten_glDetachShader,
  kf: _emscripten_glDisable,
  jf: _emscripten_glDisableVertexAttribArray,
  hf: _emscripten_glDrawArrays,
  Hb: _emscripten_glDrawArraysInstanced,
  ia: _emscripten_glDrawArraysInstancedANGLE,
  Ua: _emscripten_glDrawArraysInstancedARB,
  $c: _emscripten_glDrawArraysInstancedEXT,
  Va: _emscripten_glDrawArraysInstancedNV,
  Ic: _emscripten_glDrawBuffers,
  ...
  _c: _emscripten_glDrawElementsInstancedNV,
  Xc: _emscripten_glDrawRangeElements,
  ff: _emscripten_glEnable,
  ef: _emscripten_glEnableVertexAttribArray,
  Mc: _emscripten_glEndQuery,
  va: _emscripten_glEndQueryEXT,
  rc: _emscripten_glEndTransformFeedback,
  ...
  Lb: _emscripten_glGetActiveUniformBlockiv,
  ...
  Ab: _emscripten_glGetInteger64v,
  tc: _emscripten_glGetIntegeri_v,
  ...
  Mb: _emscripten_glGetUniformBlockIndex,
  ...
  bd: _emscripten_glPolygonModeWEBGL,
  ge: _emscripten_glPolygonOffset,
  dd: _emscripten_glPolygonOffsetClampEXT,
  ...
  fe: _emscripten_glReadPixels,
  ee: _emscripten_glReleaseShaderCompiler,
  de: _emscripten_glRenderbufferStorage,
  zc: _emscripten_glRenderbufferStorageMultisample,
  fb: _emscripten_glResumeTransformFeedback,
  ce: _emscripten_glSampleCoverage,
  ...
  be: _emscripten_glScissor,
  ae: _emscripten_glShaderBinary,
  $d: _emscripten_glShaderSource,
  _d: _emscripten_glStencilFunc,
  Zd: _emscripten_glStencilFuncSeparate,
  ...
  Vc: _emscripten_glTexImage3D,
  Sd: _emscripten_glTexParameterf,
  Rd: _emscripten_glTexParameterfv,
  Qd: _emscripten_glTexParameteri,
  Pd: _emscripten_glTexParameteriv,
  _a: _emscripten_glTexStorage2D,
  Za: _emscripten_glTexStorage3D,
  Od: _emscripten_glTexSubImage2D,
  Uc: _emscripten_glTexSubImage3D,
  ...
  Ec: _emscripten_glUniformMatrix4x2fv,
  Cc: _emscripten_glUniformMatrix4x3fv,
  rd: _emscripten_glUseProgram,
  pd: _emscripten_glValidateProgram,
  od: _emscripten_glVertexAttrib1f,
  nd: _emscripten_glVertexAttrib1fv,
  md: _emscripten_glVertexAttrib2f,
  ld: _emscripten_glVertexAttrib2fv,
  kd: _emscripten_glVertexAttrib3f,
  jd: _emscripten_glVertexAttrib3fv,
  id: _emscripten_glVertexAttrib4f,
  hd: _emscripten_glVertexAttrib4fv,
  ...
  gd: _emscripten_glVertexAttribPointer,
  ed: _emscripten_glViewport,
  ...
  k: _emscripten_sample_gamepad_data,
  ...
  Cf: _emscripten_set_main_loop_arg,
...
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["Ef"])();
var _main = (Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["Gf"])(a0, a1));
var _malloc = (a0) => (_malloc = wasmExports["Hf"])(a0);
var __emscripten_stack_restore = (a0) => (__emscripten_stack_restore = wasmExports["If"])(a0);
