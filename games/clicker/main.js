//#region all of the variables that i need
//amount of previous type to unlock
let woodMin = 20;
let stoneMin = 100;
let pStoneMin = 100;
let plantMin = 100;
...
let emeraldMin = 100;
let obsidianMin = 100;
let netheriteMin = 100;

//prices of autoclickers
let oneDirtPrice = 100;
let twoDirtPrice = 200;
let threeDirtPrice = 300;
let fourDirtPrice = 400;
let fiveDirtPrice = 500;
let sixDirtPrice = 600;

let oneWoodPrice = 100;
let twoWoodPrice = 200;
let threeWoodPrice = 300;
let fourWoodPrice = 400;
let fiveWoodPrice = 500;
let sixWoodPrice = 600;

let oneStonePrice = 100;
let twoStonePrice = 200;
let threeStonePrice = 300;
let fourStonePrice = 400;
let fiveStonePrice = 500;
let sixStonePrice = 600;

let onePStonePrice = 100;
let twoPStonePrice = 200;
let threePStonePrice = 300;
let fourPStonePrice = 400;
let fivePStonePrice = 500;
let sixPStonePrice = 600;

let onePlantPrice = 100;
let twoPlantPrice = 200;
let threePlantPrice = 300;
let fourPlantPrice = 400;
let fivePlantPrice = 500;
let sixPlantPrice = 600;

let oneGoldPrice = 100;
let twoGoldPrice = 200;
let threeGoldPrice = 300;
let fourGoldPrice = 400;
let fiveGoldPrice = 500;
let sixGoldPrice = 600;

let oneCopperPrice = 100;
let twoCopperPrice = 200;
let threeCopperPrice = 300;
let fourCopperPrice = 400;
let fiveCopperPrice = 500;
let sixCopperPrice = 600;

let oneIronPrice = 100;
let twoIronPrice = 200;
let threeIronPrice = 300;
let fourIronPrice = 400;
let fiveIronPrice = 500;
let sixIronPrice = 600;

let oneRedstonePrice = 100;
let twoRedstonePrice = 200;
let threeRedstonePrice = 300;
let fourRedstonePrice = 400;
let fiveRedstonePrice = 500;
let sixRedstonePrice = 600;

let oneDiamondPrice = 100;
let twoDiamondPrice = 200;
let threeDiamondPrice = 300;
let fourDiamondPrice = 400;
let fiveDiamondPrice = 500;
let sixDiamondPrice = 600;

let oneEmeraldPrice = 100;
let twoEmeraldPrice = 200;
let threeEmeraldPrice = 300;
let fourEmeraldPrice = 400;
let fiveEmeraldPrice = 500;
let sixEmeraldPrice = 600;

let oneObsidianPrice = 100;
let twoObsidianPrice = 200;
let threeObsidianPrice = 300;
let fourObsidianPrice = 400;
let fiveObsidianPrice = 500;
let sixObsidianPrice = 600;

let oneNetheritePrice = 100;
let twoNetheritePrice = 200;
let threeNetheritePrice = 300;
let fourNetheritePrice = 400;
let fiveNetheritePrice = 500;
let sixNetheritePrice = 600;

//autoclicker upgrades
let oneDirtSeconds = 1;
let twoDirtSeconds = 2;
let threeDirtSeconds = 4;
let fourDirtSeconds = 5;
let fiveDirtSeconds = 20;
let sixDirtSeconds = 40;

let oneWoodSeconds = 1;
let twoWoodSeconds = 2;
let threeWoodSeconds = 4;
let fourWoodSeconds = 5;
let fiveWoodSeconds = 20;
let sixWoodSeconds = 40;

let oneStoneSeconds = 1;
let twoStoneSeconds = 2;
let threeStoneSeconds = 4;
let fourStoneSeconds = 5;
let fiveStoneSeconds = 20;
let sixStoneSeconds = 40;

let onePStoneSeconds = 1;
let twoPStoneSeconds = 2;
let threePStoneSeconds = 4;
let fourPStoneSeconds = 5;
let fivePStoneSeconds = 20;
let sixPStoneSeconds = 40;

let onePlantSeconds = 1;
let twoPlantSeconds = 2;
let threePlantSeconds = 4;
let fourPlantSeconds = 5;
let fivePlantSeconds = 20;
let sixPlantSeconds = 40;

let oneGoldSeconds = 1;
let twoGoldSeconds = 2;
let threeGoldSeconds = 4;
let fourGoldSeconds = 5;
let fiveGoldSeconds = 20;
let sixGoldSeconds = 40;

let oneCopperSeconds = 1;
let twoCopperSeconds = 2;
let threeCopperSeconds = 4;
let fourCopperSeconds = 5;
let fiveCopperSeconds = 20;
let sixCopperSeconds = 40;

let oneIronSeconds = 1;
let twoIronSeconds = 2;
let threeIronSeconds = 4;
let fourIronSeconds = 5;
let fiveIronSeconds = 20;
let sixIronSeconds = 40;

let oneRedstoneSeconds = 1;
let twoRedstoneSeconds = 2;
let threeRedstoneSeconds = 4;
let fourRedstoneSeconds = 5;
let fiveRedstoneSeconds = 20;
let sixRedstoneSeconds = 40;

let oneDiamondSeconds = 1;
let twoDiamondSeconds = 2;
let threeDiamondSeconds = 4;
let fourDiamondSeconds = 5;
let fiveDiamondSeconds = 20;
let sixDiamondSeconds = 40;

let oneEmeraldSeconds = 1;
let twoEmeraldSeconds = 2;
let threeEmeraldSeconds = 4;
let fourEmeraldSeconds = 5;
let fiveEmeraldSeconds = 20;
let sixEmeraldSeconds = 40;

let oneObsidianSeconds = 1;
let twoObsidianSeconds = 2;
let threeObsidianSeconds = 4;
let fourObsidianSeconds = 5;
let fiveObsidianSeconds = 20;
let sixObsidianSeconds = 40;

let oneNetheriteSeconds = 1;
let twoNetheriteSeconds = 2;
let threeNetheriteSeconds = 4;
let fourNetheriteSeconds = 5;
let fiveNetheriteSeconds = 20;
let sixNetheriteSeconds = 40;

//prices of multipliers
let coalPrice = 20;
let torchPrice = 40;
let craftingTablePrice = 80;
let furnacePrice = 160;
let blastFurnacePrice = 400;
let comparatorMachinePrice = 1000;

//multiplier upgrades
let coalMultiplier = 2;
let torchMultiplier = 3;
let craftingTableMultiplier = 4;
let furnaceMultiplier = 5;
let blastFurnaceMultiplier = 10;
let comparatorMachineMultiplier = 20;
...
let obsidian = 0;
let netherite = 0;
let materialAmounts = [dirt, wood, stone, 
                        pstone, plant, gold, 
                        copper, iron, redstone, 
                        diamond, emerald, obsidian, netherite];

//interval trackers for autoclickers
let dirtInterval = 0;
let woodInterval = 0;
let stoneInterval = 0;
let pStoneInterval = 0;
let plantInterval = 0;
let goldInterval = 0;
let copperInterval = 0;
let ironInterval = 0;
let redstoneInterval = 0;
let diamondInterval = 0;
let emeraldInterval = 0;
let obsidianInterval = 0;
let netheriteInterval = 0;
let materialIntervals = [dirtInterval, woodInterval, stoneInterval, 
                        pStoneInterval, plantInterval, goldInterval, 
                        copperInterval, ironInterval, redstoneInterval, 
                        diamondInterval, emeraldInterval, obsidianInterval, netheriteInterval];
//#endregion

//#region array of material buttons
let buttons = Array();
let dirtButton = document.getElementById("dirtButton");
//amount added each time button is clicked
dirtButton.material = 1;
//min material needed to unlock
dirtButton.minMaterial = 0;
//ranking (same as index in array)
dirtButton.ranking = 0;
buttons.push(dirtButton);

let woodButton = document.getElementById("woodButton");
woodButton.material = 1;
woodButton.minMaterial = woodMin;
woodButton.ranking = 1;
buttons.push(woodButton);

let stoneButton = document.getElementById("stoneButton");
stoneButton.material = 1;
stoneButton.minMaterial = stoneMin;
stoneButton.ranking = 2;
buttons.push(stoneButton);

let pStoneButton = document.getElementById("pStoneButton");
pStoneButton.material = 1;
pStoneButton.minMaterial = pStoneMin;
pStoneButton.ranking = 3;
buttons.push(pStoneButton);

let plantButton = document.getElementById("plantButton");
plantButton.material = 1;
plantButton.minMaterial = plantMin;
plantButton.ranking = 4;
buttons.push(plantButton);

let goldButton = document.getElementById("goldButton");
goldButton.material = 1;
goldButton.minMaterial = goldMin;
goldButton.ranking = 5;
buttons.push(goldButton);

let copperButton = document.getElementById("copperButton");
copperButton.material = 1;
copperButton.minMaterial = copperMin;
copperButton.ranking = 6;
buttons.push(copperButton);

let ironButton = document.getElementById("ironButton");
ironButton.material = 1;
ironButton.minMaterial = ironMin;
ironButton.ranking = 7;
buttons.push(ironButton);

let redstoneButton = document.getElementById("redstoneButton");
redstoneButton.material = 1;
redstoneButton.minMaterial = redstoneMin;
redstoneButton.ranking = 8;
buttons.push(redstoneButton);

let diamondButton = document.getElementById("diamondButton");
diamondButton.material = 1;
diamondButton.minMaterial = diamondMin;
diamondButton.ranking = 9;
buttons.push(diamondButton);

let emeraldButton = document.getElementById("emeraldButton");
emeraldButton.material = 1;
emeraldButton.minMaterial = emeraldMin;
emeraldButton.ranking = 10;
buttons.push(emeraldButton);

let obsidianButton = document.getElementById("obsidianButton");
obsidianButton.material = 1;
obsidianButton.minMaterial = obsidianMin;
obsidianButton.ranking = 11;
buttons.push(obsidianButton);

let netheriteButton = document.getElementById("netheriteButton");
netheriteButton.material = 1;
netheriteButton.minMaterial = netheriteMin;
netheriteButton.ranking = 12;
buttons.push(netheriteButton);
//#endregion

//#region larger array for the div of each material
let materials = Array();
let dirtMaterial = document.getElementById("dirt");
dirtMaterial.style.display = "block";
//incase i need this later for some reason
dirtMaterial.showing = true;
materials.push(dirtMaterial);

let woodMaterial = document.getElementById("wood");
woodMaterial.style.display = "none";
woodMaterial.showing = false;
materials.push(woodMaterial);

let stoneMaterial = document.getElementById("stone");
stoneMaterial.style.display = "none";
stoneMaterial.showing = false;
materials.push(stoneMaterial);

let pStoneMaterial = document.getElementById("pstone");
pStoneMaterial.style.display = "none";
pStoneMaterial.showing = false;
materials.push(pStoneMaterial);

let plantMaterial = document.getElementById("plant");
plantMaterial.style.display = "none";
plantMaterial.showing = false;
materials.push(plantMaterial);

let goldMaterial = document.getElementById("gold");
goldMaterial.style.display = "none";
goldMaterial.showing = false;
materials.push(goldMaterial);

let copperMaterial = document.getElementById("copper");
copperMaterial.style.display = "none";
copperMaterial.showing = false;
materials.push(copperMaterial);

let ironMaterial = document.getElementById("iron");
ironMaterial.style.display = "none";
ironMaterial.showing = false;
materials.push(ironMaterial);

let redstoneMaterial = document.getElementById("redstone");
redstoneMaterial.style.display = "none";
redstoneMaterial.showing = false;
materials.push(redstoneMaterial);

let diamondMaterial = document.getElementById("diamond");
diamondMaterial.style.display = "none";
diamondMaterial.showing = false;
materials.push(diamondMaterial);

let emeraldMaterial = document.getElementById("emerald");
emeraldMaterial.style.display = "none";
emeraldMaterial.showing = false;
materials.push(emeraldMaterial);

let obsidianMaterial = document.getElementById("obsidian");
obsidianMaterial.style.display = "none";
obsidianMaterial.showing = false;
materials.push(obsidianMaterial);

let netheriteMaterial = document.getElementById("netherite");
netheriteMaterial.style.display = "none";
netheriteMaterial.showing = false;
materials.push(netheriteMaterial);
//#endregion

//on click for material buttons
for(let i = 0; i < buttons.length; i++) {
    let button = buttons[i];
    button.onclick = () => {
        addMaterial(button.material, button.ranking);
    }
}

//#region array of multiplier blocks
let multipliers = Array();
let coalMult = document.getElementById("coal");
coalMult.style.display = "none";
coalMult.showing = false;
//rank of material needed to purchase
coalMult.ranking = 1;
//whether or not upgrade has been purchased
coalMult.bought = false;
multipliers.push(coalMult);
//setting the price in js instead of html, just easier
document.getElementById("coalPrice").innerText = document.getElementById("coalPrice").innerText.replace("#", coalPrice);

let torchMult = document.getElementById("torch");
torchMult.style.display = "none";
torchMult.showing = false;
torchMult.ranking = 1;
torchMult.bought = false;
multipliers.push(torchMult);
document.getElementById("torchPrice").innerText = document.getElementById("torchPrice").innerText.replace("#", torchPrice);

let craftingTableMult = document.getElementById("craftingTable");
craftingTableMult.style.display = "none";
craftingTableMult.showing = false;
craftingTableMult.ranking = 1;
craftingTableMult.bought = false;
multipliers.push(craftingTableMult);
document.getElementById("craftingTablePrice").innerText = document.getElementById("craftingTablePrice").innerText.replace("#", craftingTablePrice);

let furnaceMult = document.getElementById("furnace");
furnaceMult.style.display = "none";
furnaceMult.showing = false;
furnaceMult.ranking = 2;
furnaceMult.bought = false;
multipliers.push(furnaceMult);
document.getElementById("furnacePrice").innerText = document.getElementById("furnacePrice").innerText.replace("#", furnacePrice);

let blastFurnaceMult = document.getElementById("blastFurnace");
blastFurnaceMult.style.display = "none";
blastFurnaceMult.showing = false;
blastFurnaceMult.ranking = 2;
blastFurnaceMult.bought = false;
multipliers.push(blastFurnaceMult);
document.getElementById("blastFurnacePrice").innerText = document.getElementById("blastFurnacePrice").innerText.replace("#", blastFurnacePrice);


let comparatorMachineMult = document.getElementById("comparatorMachine");
comparatorMachineMult.style.display = "none";
comparatorMachineMult.showing = false;
comparatorMachineMult.ranking = 8;
comparatorMachineMult.bought = false;
multipliers.push(comparatorMachineMult);
document.getElementById("comparatorMachinePrice").innerText = document.getElementById("comparatorMachinePrice").innerText.replace("#", comparatorMachinePrice);
//#endregion

//#region array for the multiplier buttons
let multButtons = Array();
let coalButton = document.getElementById("coalButton");
//price of the multiplier
coalButton.price = coalPrice;
//effect of the multiplier
coalButton.multiply = coalMultiplier;
multButtons.push(coalButton);

let torchButton = document.getElementById("torchButton");
torchButton.price = torchPrice;
torchButton.multiply = torchMultiplier;
multButtons.push(torchButton);

let craftingTableButton = document.getElementById("craftingTableButton");
craftingTableButton.price = craftingTablePrice;
craftingTableButton.multiply = craftingTableMultiplier;
multButtons.push(craftingTableButton);

let furnaceButton = document.getElementById("furnaceButton");
furnaceButton.price = furnacePrice;
furnaceButton.multiply = furnaceMultiplier;
multButtons.push(furnaceButton);

let blastFurnaceButton = document.getElementById("blastFurnaceButton");
blastFurnaceButton.price = blastFurnacePrice;
blastFurnaceButton.multiply = blastFurnaceMultiplier;
multButtons.push(blastFurnaceButton);

let comparatorMachineButton = document.getElementById("comparatorMachineButton");
comparatorMachineButton.price = comparatorMachinePrice;
comparatorMachineButton.multiply = comparatorMachineMultiplier;
multButtons.push(comparatorMachineButton);
//#endregion

//on click for multiplier buttons
for(let i = 0; i < multButtons.length; i++) {
    let button = multButtons[i];
    button.onclick = () => {
        //if can afford
        if(button.price <= getMaterialCount(multipliers[i].ranking)) {
            //adds the multiplier
            doTheMultiplierThing(button.multiply);
            //subtracts price
            subtractMaterial(button.price, multipliers[i].ranking);
            //hides it, never will come back
            multipliers[i].bought = true;
            multipliers[i].style.display = "none";
            multipliers[i].showing = false;
            update();
        }
    }
}

//adds the multiplier to each material button
function doTheMultiplierThing(multiply) {
    for(let i = 0; i < buttons.length; i++) {
        buttons[i].material = multiply;
    }
}
...
//on click for autoclick buttons
for(let i = 0; i < acButtons.length; i++) {
    let button = acButtons[i];
    button.onclick = () => {
        //if can afford & tier below is bought
        if(button.price <= getMaterialCount(autoclickers[i].ranking)) {
            //get the new (faster) interval
            updateIntervalNumber(autoclickers[i].materialRanking, button.seconds);
            //set the new interval
            updateInterval(autoclickers[i].materialRanking);
            //take away cost
            subtractMaterial(button.price, autoclickers[i].ranking);
            //hide it
            autoclickers[i].bought = true;
            autoclickers[i].style.display = "none";
            autoclickers[i].showing = false;
            update();
        }
    }
}

//#region makes the interval timers
let ticks = Array();
DIRT_TICK = setInterval(updateDirt, dirtInterval);
ticks.push(DIRT_TICK);
WOOD_TICK = setInterval(updateWood, woodInterval);
ticks.push(WOOD_TICK);
STONE_TICK = setInterval(updateStone, stoneInterval);
ticks.push(STONE_TICK);
PSTONE_TICK = setInterval(updatePStone, pStoneInterval);
ticks.push(PSTONE_TICK);
PLANT_TICK = setInterval(updatePlant, plantInterval);
ticks.push(PLANT_TICK);
GOLD_TICK = setInterval(updateGold, goldInterval);
ticks.push(GOLD_TICK);
COPPER_TICK = setInterval(updateCopper, copperInterval);
ticks.push(COPPER_TICK);
IRON_TICK = setInterval(updateIron, ironInterval);
ticks.push(IRON_TICK);
REDSTONE_TICK = setInterval(updateRedstone, redstoneInterval);
ticks.push(REDSTONE_TICK);
DIAMOND_TICK = setInterval(updateDiamond, diamondInterval);
ticks.push(DIAMOND_TICK);
EMERALD_TICK = setInterval(updateEmerald, emeraldInterval);
ticks.push(EMERALD_TICK);
OBSIDIAN_TICK = setInterval(updateObsidian, obsidianInterval);
ticks.push(OBSIDIAN_TICK);
NETHERITE_TICK = setInterval(updateNetherite, netheriteInterval);
ticks.push(NETHERITE_TICK);
//#endregion

//#region updates for each of the individual materials (maybe a better way? not sure)
function updateDirt() {
    if(dirtInterval != 0) {
        addMaterial(buttons[0].material, 0);
    }
}

function updateWood() {
    if(woodInterval != 0) {
        addMaterial(buttons[1].material, 1);
    }
}

function updateStone() {
    if(stoneInterval != 0) {
        addMaterial(buttons[2].material, 2);
    }
}

function updatePStone() {
    if(pStoneInterval != 0) {
        addMaterial(buttons[3].material, 3);
    }
}

function updatePlant() {
    if(plantInterval != 0) {
        addMaterial(buttons[4].material, 4);
    }
}

function updateGold() {
    if(goldInterval != 0) {
        addMaterial(buttons[5].material, 5);
    }
}

function updateCopper() {
    if(copperInterval != 0) {
        addMaterial(buttons[6].material, 6);
    }
}

function updateIron() {
    if(ironInterval != 0) {
        addMaterial(buttons[7].material, 7);
    }
}

function updateRedstone() {
    if(redstoneInterval != 0) {
        addMaterial(buttons[8].material, 8);
    }
}

function updateDiamond() {
    if(diamondInterval != 0) {
        addMaterial(buttons[9].material, 9);
    }
}

function updateEmerald() {
    if(emeraldInterval != 0) {
        addMaterial(buttons[10].material, 10);
    }
}

function updateObsidian() {
    if(obsidianInterval != 0) {
        addMaterial(buttons[11].material, 11);
    }
}

function updateNetherite() {
    if(netheriteInterval != 0) {
        addMaterial(buttons[12].material, 12);
    }
}
let updateFunctions = [updateDirt, updateWood, updateStone, 
                    updatePStone, updatePlant, updateGold, 
                    updateCopper, updateIron, updateRedstone, 
                    updateDiamond, updateEmerald, updateObsidian, updateNetherite];
//#endregion

//deletes the old interval and makes a new one, based on the rank/index given
function updateInterval(ranking){
    if(ranking == 0) {
        clearInterval(DIRT_TICK);
        DIRT_TICK = setInterval(updateDirt, dirtInterval);
    } else if(ranking == 1) {
        clearInterval(WOOD_TICK);
        WOOD_TICK = setInterval(updateWood, woodInterval);
    } else if(ranking == 2) {
        clearInterval(STONE_TICK);
        STONE_TICK = setInterval(updateStone, stoneInterval);
    } else if(ranking == 3) {
        clearInterval(PSTONE_TICK);
        PSTONE_TICK = setInterval(updatePStone, pStoneInterval);
    } else if(ranking == 4) {
        clearInterval(PLANT_TICK);
        PLANT_TICK = setInterval(updatePlant, plantInterval);
    } else if(ranking == 5) {
        clearInterval(GOLD_TICK);
        GOLD_TICK = setInterval(updateGold, goldInterval);
    } else if(ranking == 6) {
        clearInterval(COPPER_TICK);
        COPPER_TICK = setInterval(updateCopper, copperInterval);
    } else if(ranking == 7) {
        clearInterval(IRON_TICK);
        IRON_TICK = setInterval(updateIron, ironInterval);
    } else if(ranking == 8) {
        clearInterval(REDSTONE_TICK);
        REDSTONE_TICK = setInterval(updateRedstone, redstoneInterval);
    } else if(ranking == 9) {
        clearInterval(DIAMOND_TICK);
        DIAMOND_TICK = setInterval(updateDiamond, diamondInterval);
    } else if(ranking == 10) {
        clearInterval(EMERALD_TICK);
        EMERALD_TICK = setInterval(updateEmerald, emeraldInterval);
    } else if(ranking == 11) {
        clearInterval(OBSIDIAN_TICK);
        OBSIDIAN_TICK = setInterval(updateObsidian, obsidianInterval);
    } else if(ranking == 12) {
        clearInterval(NETHERITE_TICK);
        NETHERITE_TICK = setInterval(updateNetherite, netheriteInterval);
    } 
}

// maybe a better way of doing this
//updates the interval number
function updateIntervalNumber(ranking, newInterval) {
    if(ranking == 0) {
        dirtInterval = 1000 / newInterval;
    } else if(ranking == 1) {
        woodInterval = 1000 / newInterval;
    } else if(ranking == 2) {
        stoneInterval = 1000 / newInterval;
    } else if(ranking == 3) {
        pStoneInterval = 1000 / newInterval;
    } else if(ranking == 4) {
        plantInterval = 1000 / newInterval;
    } else if(ranking == 5) {
        goldInterval = 1000 / newInterval;
    } else if(ranking == 6) {
        copperInterval = 1000 / newInterval;
    } else if(ranking == 7) {
        ironInterval = 1000 / newInterval;
    } else if(ranking == 8) {
        redstoneInterval = 1000 / newInterval;
    } else if(ranking == 9) {
        diamondInterval = 1000 / newInterval;
    } else if(ranking == 10) {
        emeraldInterval = 1000 / newInterval;
    } else if(ranking == 11) {
        obsidianInterval = 1000 / newInterval;
    } else if(ranking == 12) {
        netheriteInterval = 1000 / newInterval;
    } 
}

//adds to the material count
function addMaterial(num, rank) {
    if(rank == 0) {
        dirt += num;
    } else if(rank == 1) {
        wood += num;
...
//takes away from the material count
function subtractMaterial(num, rank) {
    if(rank == 0) {
        dirt -= num;
    } else if(rank == 1) {
        wood -= num;
...
//gets the amount of a material depending on rank/index
function getMaterialCount(rank) {
    if(rank == 0) {
        return dirt;
    } else if(rank == 1) {
       return wood;
...
//gets the rank of the material before it (incorrectly named, oops)
function beforeButtonRank(button) {
    if(button.ranking != 0){
        return (button.ranking - 1);
    } else {
        return 0;
    }
}

function previousTierBought(tier, material) {
    for(let i = 0; i < autoclickers.length; i++) {
        let ac = autoclickers[i];
        if(ac.tier == tier - 1 && ac.materialRanking == material) {
            let bought = ac.bought;
            return bought;
        }
    }
    return false;
...
//oh, the lovely update function (oh dear)
function update() {
    // updates the materials
    document.getElementById("dirtNum").innerText = dirt;
    document.getElementById("woodNum").innerText = wood;
    document.getElementById("stoneNum").innerText = stone;
    document.getElementById("pStoneNum").innerText = pstone;
    document.getElementById("plantNum").innerText = plant;
    document.getElementById("goldNum").innerText = gold;
    document.getElementById("copperNum").innerText = copper;
    document.getElementById("ironNum").innerText = iron;
    document.getElementById("redstoneNum").innerText = redstone;
    document.getElementById("diamondNum").innerText = diamond;
    document.getElementById("emeraldNum").innerText = emerald;
    document.getElementById("obsidianNum").innerText = obsidian;
    document.getElementById("netheriteNum").innerText = netherite;

    //first is checking if new materials are unlocked
    for(let i = 0; i < buttons.length; i++) {
        let button = buttons[i];
        if(button.minMaterial <= getMaterialCount(beforeButtonRank(button))) {
            materials[i].style.display = "block";
            materials[i].showing = true;
        }
    }

    //then, checking if new multipliers can be shown
    for(let i = 0; i < multipliers.length; i++) {
        let mult = multipliers[i];
        // got to fix this appearing one at a time
        if(materials[mult.ranking].showing == true && mult.bought == false && (i == 0 || multipliers[i-1].bought == true)) {
            if(i == 0){
                document.getElementById("shopCT").style.display = "block";
            }
    ...
    //finally, checking if new autoclickers can be shown
    for(let i = 0; i < autoclickers.length; i++) {
        let ac = autoclickers[i];
        //show autoclicker option if it is either the first or previous was bought, if it wasnt bought, and if the material it needs is showing (confusing but it works!\\)
        //either tier is one or tier below it of same material is bought
        if(materials[ac.ranking].showing == true && materials[ac.materialRanking].showing == true && ac.bought == false && (ac.tier == 1 || previousTierBought(ac.tier, ac.materialRanking))) {
