  ...
  return function (moduleArg = {}) {
    ...
    var GodotAudio = {
        ...
        setVolumes(buses, volumes) {
          for (let busIdx = 0; busIdx < buses.length; busIdx++) {
            ...
            sampleNodeBus.setVolume(
              volumes.slice(busIdx * GodotAudio.MAX_VOLUME_CHANNELS, busIdx * GodotAudio.MAX_VOLUME_CHANNELS + GodotAudio.MAX_VOLUME_CHANNELS)
            );
          }
        }
      ...
      start_sample: function (playbackObjectId, streamObjectId, busIndex, startOptions) {
        ...
        const sampleNode = GodotAudio.SampleNode.create({ busIndex: busIndex, id: playbackObjectId, streamObjectId: streamObjectId }, startOptions);
        sampleNode.start();
      },
    ...
    function _godot_audio_sample_register_stream(streamObjectIdStrPtr, framesPtr, framesTotal, loopModeStrPtr, loopBegin, loopEnd) {
      ...
      GodotAudio.Sample.create(
        ...
        { loopBegin: loopBegin, loopEnd: loopEnd, loopMode: loopMode, numberOfChannels: numberOfChannels, sampleRate: sampleRate }
      );
    }
